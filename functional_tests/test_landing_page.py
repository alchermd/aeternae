...
class LandingPageTest(StaticLiveServerTestCase):
    ...
    def test_landing_page_loads_properly(self):
        ...
        self.assertContains(page_title, "Aeternae")
        header_title = self.selenium.find_element_by_tag_name("h1").text
        self.assertContains(header_title, "Aeternae")
        ...
        self.assertEquals(self.live_server_url, self.selenium.current_url)
        ...
        footer_text = self.find_element_by_tag_name("footer").text
